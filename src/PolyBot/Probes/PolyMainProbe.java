...
//        double startValue = priorities.getPriorities().get(unity.getId().charAt(0));
...
//                    value += 10 * priorities.getPriorities().get(otherUnit.charAt(4));
//                }
//            }
//            countShift++;
//            if (i >= x) {
...
//        double startValue = priorities.getPriorities().get(unity.getId().charAt(0));
//        double value = priorities.getPriorities().get(unity.getId().charAt(0));
...
//                    return new PolyPriorityUnit(priorities.getPriorities().get(unity.getId().charAt(0)), point, unity);
//                } else {
//                    return new PolyPriorityUnit(1.2 * priorities.getPriorities().get(unity.getId().charAt(0)), point, unity);
//                }
//
//            }
//        }
